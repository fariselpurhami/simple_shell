...
/**
 * main - LET'S WRITE A SHELL PROGRAM.
 * @ac: ---IT'S THE ARGUMENTS NUMBERS.
 * @av: ----IT'S AN ARGUMENTS NUMBERS.
...
int main(int ac, char **av)
{
	...
	while (1)
	{
		...
		line2 = malloc(_strlen(line) + 1 * sizeof(char));
		_cpy(line2, line);
		...
		{
			i = salir(line, line2, cont, com, av[0], i);
		}
